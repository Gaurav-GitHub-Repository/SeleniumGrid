...
public class TestCase56 extends firefoxbrowserconfig{

	static Logger log = Logger.getLogger(TestCase56.class); 
	...
	public void setBrowserConfig(String browserName)
	{
		...
		public void regression() throws IOException
		{
			...
			dashboard.setVerifyDashboard();
			//Method to call logout button
			Logout logout = new Logout(driver);
			//Method to call button
			logout.setButton();
			//Method to click on reset app state
			logout.setResetAPPState();
		}
		@Test(priority=4)
		public void logout()
		{
