...
public class TestCase33 extends firefoxbrowserconfig{

	static Logger log = Logger.getLogger(TestCase33.class); 
	...
	public void setBrowserConfig(String browserName)
	{
		...
		public void regression()
		{
			...
			login.setUsername("secret_sauce");
			//Method to enter password
			login.setPassword("standard_user");
			//Method to click on login button
			login.setSubmitButton();
			//Method to verify ogin error
			login.setLoginError3();
		}
		@Test(priority=4)
		public void logout()
		{
