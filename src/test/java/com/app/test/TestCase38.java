...
public class TestCase38 extends firefoxbrowserconfig{

	static Logger log = Logger.getLogger(TestCase38.class); 
	...
	public void setBrowserConfig(String browserName)
	{
		...
		public void regression() throws IOException
		{
			...
			//Method to click on low to high dropdown
			dashboard.setDropdown2();
