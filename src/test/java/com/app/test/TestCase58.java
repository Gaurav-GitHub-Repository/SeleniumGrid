...
import com.seleniumgrid.config.firefoxbrowserconfig;

@Listeners(listener_utility.class)
public class TestCase58 extends firefoxbrowserconfig{

	static Logger log = Logger.getLogger(TestCase58.class); 
	...
	public void setBrowserConfig(String browserName)
	{
		...
		public void regression() throws IOException
		{
			...
			dashboard.setProduct3_Button(null);
			//Method to click on cart button
			dashboard.setCartButton(null);
			//Method to click on checkout button
			dashboard.setCheckout(null);
			//Method to enter first name
			dashboard.setFirstName("Gaurav");
			//Method to enter last name
			dashboard.setLastName("Pathange");
			//Method to enter postal code
			dashboard.setPostalCode("500100");
			//Method to click on continue button
			dashboard.setContinueButton(null);
			//Method to verify product in checkout info
			dashboard.setverifyCheckoutInfo();
			//Method to click on finish button
			dashboard.setFinishButton(null);
		}
		@Test(priority=4)
		public void logout()
		{
