...
public class TestCase103 extends internetexplorerbrowserconfig{

	static Logger log = Logger.getLogger(TestCase103.class); 
	...
	public void setBrowserConfig(String browserName)
	{
		...
		public void regression() throws IOException
		{
			...
			//Method to verify checkout
			dashboard.setVerifyCheckout();
		}
		@Test(priority=4)
		public void logout()
		{
