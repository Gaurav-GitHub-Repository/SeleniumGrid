...
public class TestCase49 extends firefoxbrowserconfig{

	static Logger log = Logger.getLogger(TestCase49.class); 
	...
	public void setBrowserConfig(String browserName)
	{
		...
		public void regression() throws IOException
		{
			...
			dashboard.setCancelButton(null);
			//Method to verify cart page
			dashboard.setVerifyCart();
		}
		@Test(priority=4)
		public void logout()
		{
