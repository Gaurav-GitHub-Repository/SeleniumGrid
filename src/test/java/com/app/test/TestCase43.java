...
public class TestCase43 extends firefoxbrowserconfig{

	static Logger log = Logger.getLogger(TestCase43.class); 
	...
	public void setBrowserConfig(String browserName)
	{
		...
		public void regression() throws IOException
		{
			...
			dashboard.setRemoveButton(null);
			//Method to verify remove button
			dashboard.verifyRemoveButton(null);
		}
		@Test(priority=4)
		public void logout()
		{
