...
public class TestCase37 extends firefoxbrowserconfig{

	static Logger log = Logger.getLogger(TestCase37.class); 
	...
	public void setBrowserConfig(String browserName)
	{
		...
		public void regression() throws IOException
		{
			...
			//Method to click on high to low dropdown
			dashboard.setDropdown();
